...
from strava.strava_client import get_athlete_stats as fetch_athlete_stats  # Import added
...
# Tool definition
def get_athlete_stats_tool(athlete_id: int) -> Dict[str, Any]:
    ...
    athlete_id = int(athlete_id)  # Ensure athlete_id is an integer
    try:
